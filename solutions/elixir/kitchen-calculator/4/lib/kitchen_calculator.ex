defmodule KitchenCalculator do
  @moduledoc """
  The task explicitly asks for the use of multi-clause/pattern matching. It
  seems unnecessarily verbose and isn't very DRY though in my
  object-oriented opinion. ^-^'

  My original solution (Iteration 2) wouldn't be as performant as it has a lot
  of excess function calls, but adding or removing units would only require
