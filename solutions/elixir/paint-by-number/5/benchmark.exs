...
Benchee.run(
  %{
    ...
    "recursive_pow" => &(Benchmarks.recursive_pow(&1, 1)),
    "recursive_bitshift" => &(Benchmarks.recursive_bitshift(&1 - 1, 1)),
    "recursive_root" => &(Benchmarks.recursive_root(&1 - 1, 1)),
    "recursive_divide" => &(Benchmarks.recursive_divide(&1, 1))
  },
  inputs: inputs,
  memory_time: 2
)
