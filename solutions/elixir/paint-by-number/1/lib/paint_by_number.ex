defmodule PaintByNumber do
  ...
  Final solution creates a new function signature (pallette_bit_size/2) as I
  couldn't figure out how to do this with pallette_bit_size/1 only—I've noticed
  most if not all of the published solutions don't do that either.
  """
  ...
  defp palette_bit_size(color_count, count) do
    ...
    if result < color_count do
      palette_bit_size(color_count, count + 1)
    else
      count
    end
  end
